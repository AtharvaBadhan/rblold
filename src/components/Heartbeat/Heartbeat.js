...
import {
  getAllControllerApi,
  getAllControllerHeartBeatDetails,
} from "../../util/service";
...
const ControllerCard = (props) => {
  ...
  useEffect(() => {
    ...
    let parkingTableId = sessionStorage.getItem("selectedParkingId");
    if (!payload) {
    ...
    request.parking_table_id = parkingTableId;
    getAllControllerHeartBeatDetails(request)
      .then((res) => {
                  ...
                  <div className="col-9 col-md-9">
                    ...
                    <div className="row pt-3">
                      ...
                      <div className="col-7 col-md-6">
                        <div className={styles.SerialNoValue}>
                          {item.timestamp &&
                            moment(item.timestamp, "YYMMDDkkmmss").fromNow()}
                        </div>
                      </div>
                    </div>
                    {/* <div className="row pt-3">
