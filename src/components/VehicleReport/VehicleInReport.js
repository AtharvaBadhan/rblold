...
import { getAllVehicleInReport } from "../../util/service";
import { toast, ToastContainer } from "react-toastify";
import ReactToPrint from "react-to-print";
import { Loader } from "../Loader/Loader";

export const VehicleInReport = (props) => {
  ...
  return (
    <div className="row">
      <div className="col-12 px-4 pt-4 pb-3">
        <div className={styles.title}>Entry Vehicle Details </div>
      </div>
