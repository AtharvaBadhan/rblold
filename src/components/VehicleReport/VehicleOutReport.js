...
import * as styles from "./VehicleReport.module.css";

import { useHistory } from "react-router-dom";
import { getAllVehicleOutReport } from "../../util/service";
import { toast, ToastContainer } from "react-toastify";
import ReactToPrint from "react-to-print";
import { Loader } from "../Loader/Loader";

export const VehicleOutReport = (props) => {
  ...
  useEffect(() => {
    ...
    getAllVehicleOutReport(request)
      .then((res) => {
        handlerLoader(false);
  ...
  return (
    <div className="row">
      <div className="col-12 px-4 pt-4 pb-3">
        <div className={styles.title}>Exit Vehicle Details </div>
      </div>
